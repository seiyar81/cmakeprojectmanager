      ...
      m_kit(info.kit)
{
	...
	addPage(new CMakeRunPage(this, rmode, info.buildDirectory, info.buildType));
    init();
}
...
void CMakeOpenProjectWizard::setBuildType(const QString &type)
{
	m_buildType = type;
}
...
CMakeRunPage::CMakeRunPage(CMakeOpenProjectWizard *cmakeWizard, Mode mode, const QString &buildDirectory, const QString &buildType)
