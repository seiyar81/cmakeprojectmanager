...
const char DEBUG_ACTION_ID[] = "CMakeBuild.Debug.Action";
const char RELEASE_ACTION_ID[] = "CMakeBuild.Release.Action";
const char MINSIZE_ACTION_ID[] = "CMakeBuild.Minsize.Action";
const char RELWITHDEB_ACTION_ID[] = "CMakeBuild.Relwithdeb.Action";
